...
startButton.addEventListener('click', function(){
    ...
    if(timerStatus === "paused") {
        ...
        document.getElementById("stopButton").style.background="rgb(184, 17, 222)";
...
stopButton.addEventListener('click', function(){
    if(timerStatus === "started"){
        document.getElementById("stopButton").style.background="white";
        document.getElementById("startButton").style.background="greenyellow";
        window.clearInterval(timerInterval);
